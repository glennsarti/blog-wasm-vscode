...
type ServerCapabilities struct {
	 ...
	 */
	CodeLensProvider interface{}/*CodeLensOptions*/ `json:"codeLensProvider,omitempty"`
	/**
	 * The server provides document link support.
	 */
	DocumentLinkProvider interface{} /*DocumentLinkOptions*/ `json:"documentLinkProvider,omitempty"`
	/**
	 ...
	 */
	DocumentOnTypeFormattingProvider interface{} /*DocumentOnTypeFormattingOptions*/ `json:"documentOnTypeFormattingProvider,omitempty"`
	/**
	 ...
	 */
	ExecuteCommandProvider interface{} /*ExecuteCommandOptions*/ `json:"executeCommandProvider,omitempty"`
	/**
